...
import robot11 from '../images/grunes.jpg';
...
@observer
 class Transformers extends Component {
    ...
    buyTransformer = ()=>{
      alert('You should login first and then purchase transformers')
    }
    ...
    render(){
      return(
            <div className={"transformersDiv"}>
                ...
                <div className="video-wrapper" style={{width:"400px"}}>
                <ReactPlayer
              playsInline
              playing = {true}
              fluid={false}
            ...
            />
                ...
                <li className={"robot"}> Heimamba  
                 <Button className={"btn"} onClick={this.buyTransformer}  style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 370$ 
                 <img alt={"robot3"} className={"robotPic"} src={robot3} /> 
                 </li>
                <li className={"robot"}> Ototil  
                 <Button className={"btn"} onClick={this.buyTransformer}  style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 399$
                 <img alt={"robot4"} className={"robotPic"} src={robot4} /> 
                 </li>
                <li className={"robot"}> Robey  
                 <Button className={"btn"} onClick={this.buyTransformer} style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 350$ 
                 <img alt={"robot5"} className={"robotPic"} src={robot5} /> 
                </li>
                <li className={"robot"}> Scorpotric  
                <Button className={"btn"} onClick={this.buyTransformer}  style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 450$
                <img alt={"robot6"} className={"robotPic"} src={robot6} /> 
                </li>
                <li className={"robot"}> Serocs  
                <Button className={"btn"} onClick={this.buyTransformer}  style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 439$
                <img alt={"robot7"} className={"robotPic"} src={robot7} /> 
                </li>
                <li className={"robot"}> Makoles  
                <Button className={"btn"} onClick={this.buyTransformer}  style={{backgroundColor: '#867979', color: 'white',  marginLeft: '20px'}}> Buy</Button> 420$
